        ...
        <div className="flex justify-center mt-4 row">
            ...
            // currentPage > 1 && (
              <button
                ...
                >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className={"size-6 " + ((currentPage !== 1) ? "" : "stroke-gray-500")}>
            ...
            // currentPage < totalPages && (shownUsers.length > 4) && (
              <button 
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className={"size-6 " + ((currentPage !== 5) ? "" : "stroke-gray-500")}>
